<?php
namespace lkk\wechat\sdk;

use Yii;
use yii\base\InvalidConfigException;
use lkk\wechat\sdk\mp\Card;
use lkk\wechat\sdk\mp\Shop;
use lkk\wechat\sdk\mp\ShakeAround;
use lkk\wechat\sdk\mp\DataCube;
use lkk\wechat\sdk\mp\CustomService;
use lkk\wechat\sdk\components\BaseWechat;
use lkk\wechat\sdk\components\MessageCrypt;

/**
 * 微信公众号操作SDK
 * 注:部分功能因API的整体和功能性, 拆分为单独的类调用请查看compoents/mp文件夹
 * @package lkk\wechat\sdk
 */
